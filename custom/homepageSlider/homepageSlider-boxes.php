...
?>
        <div id="headnews" style="background: rgba(0,0,0,0.4); border-radius: 10px; color: #ffffff; position: absolute; bottom: 10px; left: 20%; right: 20%; z-index: 100;">
...
?>
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: <?php echo $width; ?>px; height: <?php echo $height; ?>px; overflow: hidden;">
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="/cms/images/stories/home/header-5.jpg" />
            </div>

            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="/cms/images/stories/home/header-6.jpg" />
            </div>
